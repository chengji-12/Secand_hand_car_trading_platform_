...
public partial class lyb : System.Web.UI.Page
{
    ...
    protected string showrely(bool isrely, string rebody)
    {
        if (isrely)
        {
            return "<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color='#2CB421'>Administrator reply:&nbsp;&nbsp;</font><font color='#000099'>" + Server.HtmlEncode(rebody) + "</font>";
        }
        else
        {
            return null;
    ...
    protected string showbody(bool ishidden, string str_body)
    {
        ...
        {
            return "<br>&nbsp;&nbsp;<font color=red>This message is a whisper! Only administrators can see it!</font>";
        }
    }
    ...
    protected string show_admin(int id)
    {
        if (Session["admin"] != null)
        {
            return "<a href=re.aspx?id=" + id + ">Reply</a>" + "&nbsp;&nbsp;&nbsp;<a href=del.aspx?id=" + id + ">Delete</a>";
        }
        else
        {
            return null;
