	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" borderColorDark="#9cc7ef" cellPadding="4" width="60%" align="center"
				...
				<tr bgColor="#4296e7">
					<td colSpan="2">
						<div align="center"><font color="#ffffff">Modify product category</font></div>
					</td>
				</tr>
				<tr>
					<td noWrap width="41%">
				...
				<tr>
					...
					<td width="59%" height="25">&nbsp;
						...
						<asp:button id="Button2" runat="server" Text="give up" onclick="Button2_Click"></asp:button></td>
				</tr>
				<tr>
					<td colSpan="2">
