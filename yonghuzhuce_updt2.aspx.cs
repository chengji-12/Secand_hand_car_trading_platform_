...
public partial class yonghuzhuce_updt2 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        sql = "update yonghuzhuce set xingming='" + xingming.Text.ToString().Trim() + "',dianhua='" + dianhua.Text.ToString().Trim() + "',shenfenzheng='" + shenfenzheng.Text.ToString().Trim() + "',youxiang='" + youxiang.Text.ToString().Trim() + "',QQ='" + QQ.Text.ToString().Trim() + "',dizhi='" + dizhi.Text.ToString().Trim() + "',xingbie='" + xingbie.Text.ToString().Trim() + "' where yonghuming='" + Session["username"].ToString().Trim() + "'";
        int result;
